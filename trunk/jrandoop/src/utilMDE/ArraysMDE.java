...
/**
 * Utilities for manipulating arrays. This complements
 * 
 * @link{java.util.Arrays}. Also, some routines also handle Collections.
 */
public final class ArraysMDE {
	...
	public static long min(long[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to min(long[])");
		long result = a[0];
		for (int i = 1; i < a.length; i++)
			result = Math.min(result, a[i]);
		return result;
	...
	public static double min(double[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to min(double[])");
		double result = a[0];
		for (int i = 1; i < a.length; i++)
			result = Math.min(result, a[i]);
		return result;
	...
	public static Integer min(Integer[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to min(Integer[])");
	...
	public static long max(long[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to max(long[])");
		long result = a[0];
		for (int i = 1; i < a.length; i++)
			result = Math.max(result, a[i]);
		return result;
	...
	public static double max(double[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to max(double[])");
		double result = a[0];
		for (int i = 1; i < a.length; i++)
			result = Math.max(result, a[i]);
		return result;
	...
	public static Integer max(Integer[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to max(Integer[])");
		Integer result = a[0]; // to return a value actually in the array
		int result_int = result.intValue(); // for faster comparison
		for (int i = 1; i < a.length; i++) {
			if (a[i].intValue() > result_int) {
	...
	/**
	 * Return a two-element array containing the smallest and largest values in
	 * the array. Return null if the array has length 0.
	 */
	public static int[] min_max(int[] a) {
		if (a.length == 0)
			// throw new ArrayIndexOutOfBoundsException("Empty array passed to
			// min_max(int[])");
			return null;
		int result_min = a[0];
		int result_max = a[0];
	...
	public static int element_range(int[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to element_range(int[])");
	...
	public static long element_range(long[] a) {
		if (a.length == 0)
			throw new ArrayIndexOutOfBoundsException(
					"Empty array passed to element_range(long[])");
	 ...
	 * testing for equality using the equals method.
	 * 
	 * @return the first index i containing the specified element, such that
	 *         minindex <= i < indexlimit, or -1 if the element is not found in
	 *         that section of the array.
	 * @see java.util.List#indexOf(java.lang.Object)
	 */
	public static int indexOf(Object[] a, Object elt, int minindex,
			int indexlimit) {
	 ...
	 * testing for equality using the equals method. Identical to List.indexOf,
	 ...
	 * 
	 * @return the first index containing the specified element, or -1 if the
	 ...
	 * @see java.util.Vector#indexOf(java.lang.Object)
	 */
	public static int indexOfEq(Object[] a, Object elt, int minindex,
			int indexlimit) {
		for (int i = minindex; i < indexlimit; i++)
			if (elt == a[i])
				return i;
	 ...
	 * @see java.util.Vector#indexOf(java.lang.Object)
	 */
	public static int indexOf(boolean[] a, boolean elt, int minindex,
			int indexlimit) {
		for (int i = minindex; i < indexlimit; i++)
			if (elt == a[i])
				return i;
	...
	/**
	 * Searches for the first subsequence of the array that matches the given
	 * array elementwise, testing for equality using the equals method.
	 * 
	 * @return the first index at which the second array starts in the first
	 *         array, or -1 if no such element is found in the array.
	 * @see java.util.Vector#indexOf(java.lang.Object)
	...
	/**
	 * Searches for the first subsequence of the array that matches the given
	 * array elementwise, testing for equality using == (not the equals method).
	 * 
	 * @return the first index at which the second array starts in the first
	 *         array, or -1 if the element is not found in the array.
	 * @see java.util.Vector#indexOf(java.lang.Object)
	 * @see java.lang.String#indexOf(java.lang.String)
	 */
	...
	/**
	 * Searches for the first subsequence of the list that matches the given
	 * array elementwise, testing for equality using the equals method.
	 * 
	 * @return the first index at which the second array starts in the first
	 *         list, or -1 if no such element is found in the list.
	 * @see java.util.Vector#indexOf(java.lang.Object)
	 * @see java.lang.String#indexOf(java.lang.String)
	 */
	...
	/**
	 * Searches for the first subsequence of the array that matches the given
	 * list elementwise, testing for equality using the equals method.
	 * 
	 * @return the first index at which the second list starts in the first
	 *         array, or -1 if no such element is found in the array.
	 * @see java.util.Vector#indexOf(java.lang.Object)
	 * @see java.lang.String#indexOf(java.lang.String)
	 */
	...
	/**
	 * Searches for the first subsequence of the array that matches the given
	 * list elementwise, testing for equality using == (not the equals method).
	 * 
	 * @return the first index at which the second list starts in the first
	 *         array, or -1 if the element is not found in the array.
	 * @see java.util.Vector#indexOf(java.lang.Object)
	 ...
	 * @param length
	 *            the number of elements to include (not an end index, to avoid
	 *            confusion over whether it would be the last included index or
	 *            the first non-included index)
	 */
	...
	/**
	 * Return an array that contains all the elements of both argument arrays,
	 * in order. If both arguments are null, returns null. Returns a new array
	 * unless one argument is null, in which case it returns the other array.
	 */
	...
	public static <T> T[] concat(T[] a, List<T> b) {
		if (a == null && b == null)
			return null;
		if (a == null)
			return (T[]) b.toArray(); // unchecked cast
		if (b == null)
			return a;
	...
	public static <T> T[] concat(List<T> a, T[] b) {
		...
		if (a == null)
			return b;
		if (b == null)
			return (T[]) a.toArray(); // unchecked cast
	...
	/**
	 * Determines whether the second array is a subarray of the first, starting
	 * at the specified index of the first, testing for equality using the
	 * equals method.
	 * 
	 * @return the first index at which the second array starts in the first
	 *         array, or -1 if no such element is found in the array.
	...
	/**
	 * Determines whether the second array is a subarray of the first, starting
	 * at the specified index of the first, testing for equality using == (not
	 * the equals method).
	 * 
	 * @return the first index at which the second array starts in the first
	 *         array, or -1 if the element is not found in the array.
	...
	/**
	 * Determines whether the second array is a subarray of the first, starting
	 * at the specified index of the first.
	 * 
	 * @return the first index at which the second array starts in the first
	 *         array, or -1 if the element is not found in the array.
	 */
	...
	/**
	 * Return a string representation of the array. The representation is
	 * patterned after that of java.util.Vector.
	 * 
	 ...
	 *             if obj is null or is not one of the types mentioned above.
	 */
	public static String toString(Object obj) throws IllegalArgumentException {
		if (obj instanceof boolean[]) {
			...
			throw new IllegalArgumentException("Argument is "
					+ ((obj == null) ? "null" : "of class "
							+ obj.getClass().getName()));
		}
	}

	/**
	 * Casts obj down to the proper array type then calls .length. Only call
	...
	/**
	 * @return true iff a does not contain duplicate elements using O(n) time
	 *         and O(n) space.
	 */
	...
	/**
	 * @return true iff a does not contain duplicate elements using O(n) time
	 *         and O(n) space. Equality checking uses the .equals() method for
	 *         java.lang.Double.
	 */
	...
	/**
	 * @return true iff all elements of a are in [0..a.length) and a contains no
	 *         duplicates.
	 */
	public static boolean fn_is_permutation(int[] a) {
		// In the common case we expect to succeed so use as few loops as
		// possible
	...
	/**
	 * @param a
	 *            function from [0..a.length) to [0..arange)
	 * @return function from [0..arange) to [0..a.length) that is the inverse of
	 *         a
	...
	/**
	 * @param a
	 *            function from [0..a.length) to [0..b.length)
	 * @param b
	 *            function from [0..b.length) to range R
	 * @return function from [0..a.length) to range R that is the composition of
	 *         a and b
	 */
	...
	/**
	 * Whether smaller is a subset of bigger. The implmentation is to use
	 * collections because we want to take advantage of HashSet's constant time
	 * membership tests.
	 */
	 ...
	 * equals. That is, it may return 0 if the arrays are not equal (but do
	 * contain identical numbers).
	 */
	public static final class IntArrayComparatorLexical implements
			Comparator<int[]> {
	 ...
	 * contain identical numbers).
	 */
	public static final class LongArrayComparatorLexical implements
			Comparator<long[]> {
	 ...
	 * contain identical numbers).
	 */
	public static final class DoubleArrayComparatorLexical implements
			Comparator<double[]> {
	 ...
	 */
	public static final class StringArrayComparatorLexical implements
			Comparator<String[]> {
	 ...
	 * contain identical objects).
	 */
	public static final class ObjectArrayComparatorLexical implements
			Comparator<Object[]> {
		public int compare(Object[] a1, Object[] a2) {
			...
			for (int i = 0; i < len; i++) {
				...
				// number for each Object in the system. This checks that
				// assumption.
				Assert.assertTrue(elt1.equals(elt2));
			}
			return a1.length - a2.length;
	 ...
	 * contain identical numbers).
	 */
	public static final class IntArrayComparatorLengthFirst implements
			Comparator<int[]> {
		public int compare(int[] a1, int[] a2) {
			if (a1 == a2)
				return 0;
	 ...
	 * contain identical numbers).
	 */
	public static final class LongArrayComparatorLengthFirst implements
			Comparator<long[]> {
		public int compare(long[] a1, long[] a2) {
			if (a1 == a2)
				return 0;
	 ...
	 * contain identical objects).
	 */
	public static final class ObjectArrayComparatorLengthFirst implements
			Comparator<Object[]> {
		public int compare(Object[] a1, Object[] a2) {
			if (a1 == a2)
				return 0;
	...
	/**
	 * @return true iff all elements of a are null (unspecified result if a is
	 *         zero-sized)
	 */
