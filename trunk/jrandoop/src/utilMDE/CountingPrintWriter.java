...
/**
 * <p>
 * Prints formatted representations of objects to a text-output stream counting
 * the number of bytes & characters printed.
 * </p>
 * <br>
 * 
 * <p>
 * Methods in this class never throw I/O exceptions. The client may inquire as
 * to whether any errors have occurred by invoking checkError().
 * </p>
 */
...
public class CountingPrintWriter extends PrintWriter {
	...
	/**
	 * Returns the number of bytes contained in a string. If s is null, returns
	 * -1
	 * 
	 * @param s
	 *            A String
	...
	/**
	 * Returns the total number of bytes printed using any of the 'print' or
	 * 'println' methods of this CountingPrintBuffer.
	 */
	...
	/**
	 * Returns the total number of bytes printed using any of the 'write'
	 * methods of this CountingPrintBuffer.
	 */
	...
	/**
	 * Returns the total number of characters printed using any of the 'print'
	 * or 'println' methods of this CountingPrintBuffer.
	 */
