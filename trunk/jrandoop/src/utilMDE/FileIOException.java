...
/**
 * This class extends IOException by also reporting a file name and line number
...
public class FileIOException extends IOException {
	...
	public FileIOException(LineNumberReader reader, String fileName,
			Throwable cause) {
		super(cause.getMessage());
		initCause(cause);
		this.fileName = fileName;
	...
	public String toString() {
		if (fileName == null || lineNumber == -1) {
			...
			return "Error: " + super.toString() + " on line " + lineNumber
					+ " of file " + fileName;
		}
	}
