...
public class Case implements CoverageAtom, Serializable {
	...
	public final int switchNumber; // Switch number recorded by coverage
									// tracking tool.
	...
	public static Case getSwitchInfo(String className, int lineNumber,
			int switchNumber, int caseNumber) {
	...
	public Case(String className, int lineNumber, int switchNumber,
			int caseNumber) {
		if (className == null)
	...
	public String toString() {
		return "swtich:name=" + className + "line=" + lineNumber + ",num="
