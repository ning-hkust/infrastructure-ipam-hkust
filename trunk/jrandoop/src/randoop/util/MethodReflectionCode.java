...
public final class MethodReflectionCode extends ReflectionCode {
	...
	private void checkRep() {
		if (Globals.nochecks)
			return;
		String error = Reflection.checkArgumentTypes(inputs, method
		...
		if (Modifier.isStatic(this.method.getModifiers())) {
			...
			if (!Reflection.canBePassedAsArgument(receiver, method
					.getDeclaringClass()))
	...
	public String toString() {
		String ret = "Call to " + method.toString() ;
		if (receiver != null)
			try{
			ret += " receiver:" + receiver.toString() + " args:";
			} catch (java.util.ConcurrentModificationException e){
				
			}
		else
			ret += " receiver:null args:";
