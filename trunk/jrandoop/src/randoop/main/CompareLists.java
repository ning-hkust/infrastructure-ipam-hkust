...
/**
 * Compares SimpleLists of objects for equality. Prints message to stdout with
 * summary of comparison. If called with more than two arguments, compares the
 * first to each of the rest; it's OK if it only matches one. If suites differ,
...
public class CompareLists {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i < args.length; i++) {
			...
			SimpleList s2 = (SimpleList) SerializationHelper
					.readSerialized(suite2);
