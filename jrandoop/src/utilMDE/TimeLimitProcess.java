...
/**
 * TimeLimitProcess is a subclass of Process such that the process is killed if
 * it runs for more than the specified number of milliseconds. Wall clock
 * seconds, not CPU seconds, are measured.
 */
