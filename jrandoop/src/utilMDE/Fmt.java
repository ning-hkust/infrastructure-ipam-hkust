 ...
 * All of the arguments must be objects. Primitive types can be used in several
 * ways:
 *  - Add them to a string: "" + i - create a wrapper object: new Integer(i) -
 * use a fmt routine to create a wrapper object: Fmt.i(i)
 */
public class Fmt {

	/**
	 * Replaces each instance of %s in format with the corresponding object in
	 * args and writes the result to System.out. Each argument is converted to a
	...
	/**
	 * Replaces each instance of %s in format with the corresponding object in
	 * args and returns the result. Each argument is converted to a string with
	 * toString()
	 */
	public static String spf(String format, Object[] args) {

		StringBuffer result = new StringBuffer(format.length() + args.length
				* 20);
		...
		if (current_arg != args.length)
			throw new RuntimeException(spf(
					"spf: only %s of %s arguments used up: [result = %s]",
	...
	public static void pf(String format, Object arg1, Object arg2, Object arg3) {
	...
	static public void pf(String format, Object arg1, Object arg2, Object arg3,
