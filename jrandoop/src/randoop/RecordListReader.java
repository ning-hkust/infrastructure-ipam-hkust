 ...
 * 
 * A record is a sequence of lines, beginning with the string "START
 * <recordtype>" and ending with the string "END <recordtype>" where
 * <recordtype> is specified by the client. For example:
 * 
 * START person ... ... arbitrary text ... END person
 * 
 * Whitespace is allowed between records, as well as comment lines. A comment
 * line is a line that begins with "#".
 * 
