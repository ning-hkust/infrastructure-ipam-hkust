...
public class StatName implements Serializable {
	...
	public StatName(String longName, String shortName, String explanation,
			boolean printable) {
		if (shortName == null || longName == null)
			throw new IllegalArgumentException("parameters cannot be null.");
		if (shortName.length() > MAX_LENGTH_SHORT_NAME)
			throw new IllegalArgumentException(
					"shortName's length must be at most "
							+ MAX_LENGTH_SHORT_NAME + " :" + shortName);
