...
/**
 * A collection of static methods that randoop uses to serialize and deserialize
 * its data structures. Mainly concerns (de)serialization of reflection objects
 * like methods, constructors and classes.
 * 
 */
