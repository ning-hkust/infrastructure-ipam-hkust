...
public final class RandoopModelToTxt {
	...
	public static void main(String[] args) {
		...
		List<StatementKind> model = (List<StatementKind>) SerializationHelper
				.readSerialized(modelFileName);
	...
	private static void printUsage(PrintStream out) {
		out.println("usage: java " + RandoopModelToTxt.class.getCanonicalName()
				+ " <randoop model> <text model name>");
	}
